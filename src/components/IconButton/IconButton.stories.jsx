...
/** Two variants, `plain` and `soft`, which between them cover every icon action
 *  the four screens need. Every icon button is 44 x 44 even though the glyph is
 *  24px, so the hit area is larger than the mark. The dashed outline below is
 *  the target, drawn for this story only. */
export const Variants = {
  render: () => (
    <Frame>
      <Note>plain · soft — all 44 x 44</Note>
